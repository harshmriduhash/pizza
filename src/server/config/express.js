...
export default (app) => {
  if (isProduction || isIntegration) {
    ...
    app.set('port', isProduction ? 8478 : 8479);
  } else {
  ...
  // create a rotating write streamer
  ...
  const sess = {
    ...
    secret: defines.__SESSION_SECRET__,
    proxy: !isDev, // The "X-Forwarded-Proto" header will be used.
    name: 'sessionId',
